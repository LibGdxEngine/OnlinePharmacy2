package com.devahmed.techx.foxmart.Screens.AddProducts;
...
import com.devahmed.techx.foxmart.Screens.AddProducts.AddProductUseCase.GetImageUseCase;
import com.devahmed.techx.foxmart.Screens.AdminDashboard.BranchesControl.UseCases.FetchBranchesUseCase;
import com.devahmed.techx.foxmart.Screens.Home.UseCases.AddCategoryUseCase;
import com.devahmed.techx.foxmart.Screens.SubCategories.UseCase.AddSubCategoryUseCase;
...
public class AddProductFragment extends BaseFragment implements AddProductMvc.Listener, AddProductUseCase.Listener, AddSubCategoryUseCase.Listener, AddCategoryUseCase.Listener, FetchBranchesUseCase.Listener {
    ...
    public void onPublishBtnClicked() {
        ...
        if(mode == MODE.ADD_PRODUCT){
            ...
            updatedProduct.setPrice(Integer.parseInt(mvcImp.getPrice()));
