package com.devahmed.techx.aswaqmisr.Utils;
...
public class BillCanvasView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine((float)(getWidth() * 0.35) , (float)(getHeight() * 0.1) ,(float)(getWidth() * 0.35), (float) (getHeight() * 0.05 * (productList.size() + DISTANCE_BETWEEN_TEXTS  + 1)) , mPaint);
        canvas.drawText("Price", (float) (getWidth() * 0.4), (float) (getHeight() * 0.1), mTextPaint);
        canvas.drawLine((float)(getWidth() * 0.55) , (float)(getHeight() * 0.1) ,(float)(getWidth() * 0.55), (float) (getHeight() * 0.05 * (productList.size() + DISTANCE_BETWEEN_TEXTS  + 1)) , mPaint);
        canvas.drawText("Count", (float) (getWidth() * 0.6), (float) (getHeight() * 0.1), mTextPaint);
        canvas.drawLine((float)(getWidth() * 0.75) , (float)(getHeight() * 0.1) ,(float)(getWidth() * 0.75), (float) (getHeight() * 0.05 * (productList.size() + DISTANCE_BETWEEN_TEXTS  + 1)) , mPaint);
