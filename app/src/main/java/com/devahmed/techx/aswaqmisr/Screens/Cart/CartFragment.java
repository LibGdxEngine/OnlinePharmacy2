package com.devahmed.techx.aswaqmisr.Screens.Cart;
...
import com.devahmed.techx.aswaqmisr.R;
import com.devahmed.techx.aswaqmisr.Screens.AdminDashboard.BranchesControl.UseCases.FetchBranchesUseCase;
import com.devahmed.techx.aswaqmisr.Screens.AdminDashboard.MinChargeControl.UseCase.FetchMinChargesUseCase;
import com.devahmed.techx.aswaqmisr.Screens.Cart.UseCase.FetchCartDataUseCase;
import com.devahmed.techx.aswaqmisr.Screens.AdminDashboard.DeliverCost.UseCases.FetchDeliveryCostesUseCase;
import com.devahmed.techx.aswaqmisr.Screens.LocationAtFirstTime.LocationAtFirstTime;
...
public class CartFragment extends Fragment implements CartMvc.Listener, FetchCartDataUseCase.Listener, FetchUserInfoFromFirebaseUseCase.Listener, FetchDeliveryCostesUseCase.Listener, FetchMinChargesUseCase.Listener, FetchBranchesUseCase.Listener {
    ...
    public void onSubmitBtnClicked(int totalEarnedPoints) {
        ...
        if(branch.getIsOpenNow() == false){
            ...
            dialog.showTextMessage(getContext().getResources().getString(R.string.sorry_closed_now) + " 9:00 AM");
        }
        if(isUserBlocked){
